...
public class Game1 : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        Texture2D _bulletTexture = Content.Load<Texture2D>("Bullet_SI-1");
        ...
        _player = new Player(_playerSprite, _bulletTexture, startPosition);
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        _inputManager.Update(); //updaterar tangent och mustillstånd först 
        _player.Update(gameTime, _displayManager.Width, _inputManager); // Skicka vidare updates till spelare
